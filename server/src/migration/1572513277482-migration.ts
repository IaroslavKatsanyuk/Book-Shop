...
export class migration1572513277482 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `authorInBook` (`authorId` int NOT NULL, `printingEditionId` int NOT NULL, `date` datetime NOT NULL, PRIMARY KEY (`authorId`)) ENGINE=InnoDB", undefined);
